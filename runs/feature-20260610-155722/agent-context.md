...
- `app/sources/page.tsx` — the only file requiring changes. The title block is at lines 150–157 (`<h1>Источники</h1>`, subtitle `<p>`, and the existing helper `<p>`). All other "Affected Files" (API routes, collectors, parsers
