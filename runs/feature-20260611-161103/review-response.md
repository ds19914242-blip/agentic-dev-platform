...
The implementation matches the approved plan exactly — only the two affected UI files changed, all string-only Russian translations, typecheck and build pass.
