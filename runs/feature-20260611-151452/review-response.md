...
The implementation matches the approved plan exactly. Both target components (`SourcePicker.tsx`, `PreviewPanel.tsx`) have all visible English translated to Russian, and the API route changes are limited to user-visible error strings as scoped. Build and typecheck both pass.
