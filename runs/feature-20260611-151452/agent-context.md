...
- **Encoding/escaping**: Cyrillic plus special punctuation in JSX/TS string literals must stay UTF-8 and properly quoted; watch apostrophes in JS
...
- **Term consistency**: ensure AI-summary wording matches the existing "AI-описания" phrasing already present in PreviewPanel so the U
