...
The targeted English UI labels and error strings are gone (remaining matches are code identifiers like `isActive`, not UI text). Build and typecheck both passed.
